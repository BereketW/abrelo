...
export default function About(){
    return(
        <main id="main-content" className="grow  mt-8 lg:pt-0">
          ...
          <div className="col-span-full grid grid-cols-9 gap-5 md:gap-[30px] lg:col-span-9">
            <div className="col-span-full md:col-span-3">
              <div className="relative flex h-[360px] flex-col items-center justify-center overflow-hidden bg-white dark:bg-gray-800 pb-16 text-center shadow-3xl">
                ...
                <svg className="absolute -right-[32px] -bottom-[20px] h-[116px] w-[calc(100%+32px)] min-w-[480px]"
                width="480" height="116" viewBox="0 0 480 116" fill="none" stroke="none">
                  <path className="fill-gray-150 dark:fill-gray-700" fill-rule="evenodd" clip-rule="evenodd"
                  ...
                  <path className="fill-gray-180 dark:fill-gray-900" fill-rule="evenodd" clip-rule="evenodd"
            ...
            <div className="col-span-9">
              <div className="relative flex min-h-[220px] flex-wrap bg-white dark:bg-gray-800 shadow-3xl overflow-hidden">
                <div className="relative flex-1 basis-full px-6 pt-8 pb-11 md:p-11 md:pr-14 md:basis-auto">
                  ...
                  <div className="absolute -left-[39px] -bottom-[46px] h-[90px] w-[calc(100%+39px)] bg-bars-gray dark:bg-dark-bars-gray bg-[length:576px_90px] bg-repeat-x">
                  </div>
                  <div className="absolute -left-[39px] -bottom-[55px] h-[81px] w-[calc(100%+39px)] bg-bars-hero bg-[length:576px_81px] bg-repeat-x">
                  </div>
                  <div className="absolute -left-[27px] -bottom-[46px] h-[72px] w-[calc(100%+27px)] bg-bars-hero-200 bg-[length:539px_79px] bg-repeat-x">
                  </div>
                </div>
          ...
          <div className="col-span-full grid grid-cols-2 lg:col-span-3 gap-7 md:gap-[30px]">
            <div className="col-span-full sm:col-span-1 lg:col-span-full">
              <div className="relative overflow-hidden shadow-3xl bg-white dark:bg-gray-800 min-h-[130px] pl-6 xl:pl-10 py-6">
                <div className="font-bold text-primary dark:text-white text-2xl leading-none xl:text-[26px] tracking-tighter mb-2 uppercase flex items-start gap-x-3">
                  ...
                  <span className="inline-flex items-center gap-1">
                    <svg role="img" className="h-4 w-4 fill-info">
                      <use xlink="https://valkivid.dan-fisher.dev/assets/img/yt1/sprite.svg#plus-circle">
                      </use>
                    </svg>
                ...
                <svg className="absolute -right-[80px] -bottom-6 w-[244px] h-[182px]" width="244"
                height="182" viewBox="0 0 244 182" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path className="fill-hero" fill-rule="evenodd" clip-rule="evenodd" d="M3.10003 179.999C3.10003 179.999 13.096 130.04 75.094 128.119C134.669 126.273 149.037 97.856 149.1 65.999C150.99 33.213 182.535 1.99899 241.1 1.99899L233.1 179.999H3.10003Z">
                  </path>
                  <path className="fill-hero-600" fill-rule="evenodd" clip-rule="evenodd"
                  ...
                  <path className="fill-white dark:fill-gray-700" fill-rule="evenodd" clip-rule="evenodd"
                ...
                <div className="font-bold text-primary dark:text-white text-2xl leading-none xl:text-[26px] tracking-tighter mb-2 uppercase flex items-start gap-x-3">
                  ...
                  <span className="inline-flex items-center gap-1">
                    <svg role="img" className="h-4 w-4 fill-danger">
                      <use xlink="https://valkivid.dan-fisher.dev/assets/img/yt1/sprite.svg#minus-circle">
                      </use>
                    </svg>
                    <span className="font-bold text-primary dark:text-white text-xs leading-none tracking-normal">
                      0.3%
