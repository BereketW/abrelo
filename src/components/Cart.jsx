    ...
    <div className="">
      <span className="flex  justify-between items-center">
        ...
        <button
          ...
          className="w-9  border font-bold flex items-center justify-center dark:border-white  dark:border-2 border-black h-9 rounded-full "
        >
          <RiCloseLine />
        </button>
      </span>
      <div className="grid gap-4  overflow-y-scroll oveflow-x-hidden w-full py-4 mt-10 ">
        {cartProducts.length > 0 ? (
          ...
          <div>
            ...
            <div className="my-10">
              <Link
                href={"/shop"}
                className="rounded dark:text-white dark:shadow-md dark:border-hero border inline-flex gap-3 left-1/2 relative -translate-x-1/2 bg-hero text-white px-6 py-3"
              >
                Go to shop <MoveRightIcon />
              </Link>
            </div>
          </div>
        )}
