    ...
    <main id="main-content" className="grow lg:pt-0">
      <div className="pt-14 pb-10 lg:pb-10 lg:pt-40">
        <div className="container">
          <div className="relative -mt-20 mb-14 grid grid-cols-12 gap-x-5 gap-y-10 md:gap-x-[30px] bg-white dark:bg-gray-800 shadow-3xl lg:-mt-[200px] lg:mb-40 py-10 md:py-20 lg:py-22 xl:py-24 isolate">
            ...
            <div className="col-start-2 md:col-start-6 col-end-12">
              <form className="grid grid-cols-1 md:grid-cols-2 gap-7" action="#">
                ...
                <div className="col-span-full">
                  <textarea
                    className="border border-gray-300 block border-base w-full px-7 py-4 leading-8 tracking-tight text-primary transition-all duration-150 placeholder:text-gray-500/60 focus:border-indigo-500 focus:outline-0 focus:ring-0 dark:border-white/10 dark:bg-gray-800 dark:text-white dark:placeholder:text-gray-500/80 dark:focus:border-indigo-500 h-40 md:h-52"
                    name="post-comment"
                    id="post-comment"
                ...
                <div className="col-span-full">
                  <input
                    className="bg-hero font-bold text-white text-lg tracking-tight py-5 leading-normal mt-4 md:mt-8 hover:cursor-pointer hover:bg-hero/90 transition-colors block w-full"
                    type="submit"
                    value="Send Message"
                  />
                </div>
