      ...
      <div className="lg:flex lg:px-24 justify-center gap-10">
        ...
        <div className="border-y-[10px] rounded-[10px] border-primary p-10">
          ...
          <div className="my-6 flex justify-between items-center">
            <h3 className="flex text-primary  gap-4 items-center">
              <BsCardImage className="dark:text-hero" /> Apply coupons
            </h3>
            <button className="px-4 py-0.5 box-border rounded bg-primary dark:bg-hero uppercase text-white ">
              Apply
            </button>
          </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="flex items-center gap-2">
              <CurrencyFormat amount={100} /> free
            </span>
          </div>
          <div className="flex justify-between items-center">
          ...
          <button className="w-full p-3 bg-black my-6 rounded  dark:bg-hero text-white font-bold">
            Place Order
          </button>
