...
export default function NavLink({ href, children,footer=false }) {
    ...
    <li>
      <Link
        className={`dark:hover:after:bg-white relative inline-flex items-center gap-x-2 leading-10 
          ${isActive ? "after:bg-white after:scale-x-100":""} 
          ${isHomePage ? "hover:after:bg-white" : "hover:after:bg-white"} 
