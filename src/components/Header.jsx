  ...
  return (
    <header className="">
      <nav className={`relative ${className}    z-50 flex min-h-[64px] dark:text-white items-center justify-between py-1  lg:min-h-[90px] lg:py-4`}>
        ...
        <ul className={`lg:p-0 ${hidden ? "translate-x-[10000%] " : "translate-x-0"} lg:translate-x-0 lg:text-inherit transition-all duration-500 ease-[cubic-bezier(.57,.21,.69,1.25)] text-primary fixed lg:static lg:h-auto h-svh z-50 top-0 right-0 p-12 rounded lg:w-auto w-full lg:bg-inherit bg-white lg:gap-x-7 gap-x-7 xl:gap-x-10 text-sm flex-cols font-bold lg:flex`}>
